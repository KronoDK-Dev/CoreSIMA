...
{
    public class ProveedoresNTAD : BaseAD
    {
        ...
        public DataTable Listar_PDT601_4TA(string D_FECHAPRO, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_PDT601_4TA";
                ...
                Param[0] = new OracleParameter("D_FECHAPRO", OracleDbType.Varchar2);
                Param[0].Direction = ParameterDirection.Input;
                Param[0].Value = D_FECHAPRO;
        ...
        public DataTable Listar_PDT601_PS4(string D_FECHAPRO, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_PDT601_PS4";
        ...
        public DataTable Listar_Reg_Retencion_4TA(string D_FECHAPRO, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_Reg_Retencion_4TA";
        ...
        public DataTable Listar_Salidas_Dev_Prov(string N_CEO, string V_PROCESO, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_Salidas_Dev_Prov";
                ...
                Param[1] = new OracleParameter("V_PROCESO", OracleDbType.Varchar2);
                Param[1].Direction = ParameterDirection.Input;
                Param[1].Value = V_PROCESO;
        ...
        public DataTable Listar_ProgramaAdquiEnvioCot(string PROGRAMA_ADQUISICION, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_ProgramaAdquiEnvioCot";
                ...
                OracleParameter[] Param = new OracleParameter[2];
                Param[0] = new OracleParameter("PROGRAMA_ADQUISICION", OracleDbType.Varchar2);
                Param[0].Direction = ParameterDirection.Input;
                Param[0].Value = PROGRAMA_ADQUISICION;
            ...
            string Procedencia, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_RegistroProveedores";
                ...
                Param[0] = new OracleParameter("Fecha_Registro", OracleDbType.Varchar2);
                Param[0].Direction = ParameterDirection.Input;
                Param[0].Value = Fecha_Registro;

                Param[1] = new OracleParameter("Estado", OracleDbType.Varchar2);
                Param[1].Direction = ParameterDirection.Input;
                ...
                Param[3] = new OracleParameter("RUC", OracleDbType.Varchar2);
