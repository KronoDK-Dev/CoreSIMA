    ...
    public class MaterialesNTAD : BaseAD
    {
            ...
            string CLASIFICACION, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_ConsumoAnualMateriales";
            ...
            string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_Mat_CentroOperativo";
            ...
            string Fecha_Llegada_Termino, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_MatLLegadoCompras";
        ...
        public DataTable Listar_CatalogoMaterialesFC(string D_FechaIEmision, string D_FechaFEmision, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_CatalogoMaterialesFC";
            ...
            string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_VM_CC";
            ...
            string FECHA_FINAL_MOVIMIENTO, string CODIGO_MATERIAL, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_MoviMatIOCVSMVDE";
            ...
            string Fecha_Inicial, string Fecha_Final, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_MoviMaterialAud";
            ...
            string V_CANTREQ, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_EQUIVA2013";
            ...
            string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_VM_CC_ESPECIFICO";
            ...
            string D_FECHA_RESERVA_final, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_ControlReservaMat";
        ...
        public DataTable Listar_SaldoAlmacen(string Material_Inicial, string Material_Final, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_SaldoAlmacen";
            ...
            string D_Fecha_Termino, string V_CC, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_AtencionMaterialesCC";
            ...
            string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_CONSUMO_VM_VALJDE";
            ...
            string FECHA_ATENCION_TERMINO, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_SeguiRequeDeta_OTS";
        ...
        public DataTable Listar_PRECIOSREPOSICION(string CLAS_MATERIAL, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_PRECIOSREPOSICION";
            ...
            string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_Punto_Reposicion";
            ...
            string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_Punto_Repo_Precios_Prome";
            ...
            string EMISION_FINAL_PEDIDO, string CODIGO_MATERIAL, string CODIGO_AUXILIAR, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_PedidoMateMultipropo";
            ...
            string Estado_Seguimiento_OT, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_Reserva_OT_Produccion";
        ...
        public DataTable Listar_MAT_MASIVA(string CLASE_SUBCLASE, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_MAT_MASIVA";
            ...
            string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_ReserMateAreasUsua";
        ...
        public DataTable Listar_CODIFICACION_CUBSO(string CLASE, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_CODIFICACION_CUBSO";
        ...
        public DataTable Listar_PedidoMaterialCompraOTS(string DIVISION, string NRO_PEDIDO, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_PedidoMaterialCompraOTS";
            ...
            string Fecha_Final, string Clase, string Stock, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_MatlesSinMov_PDR8701";
            ...
            string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_VALE_SALIDA_MAT";
            ...
            string C_DESTINO_OPER, string V_COD_CLASE_MAT, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_ControlMateriales";
            ...
            string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_SALDO_HISTORICO_MAT";
            ...
            string Fecha_Emision, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_DET_G_PRY_OT_VSM_PCI";
