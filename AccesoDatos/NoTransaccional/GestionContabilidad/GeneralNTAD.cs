...
{
    public class GeneralNTAD : BaseAD
    {
        ...
        public DataTable Listar_forma_pago_sunat_pdb_txt(string D_AÑO, string D_MES, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_CONTABILIDAD.SP_FORMA_PAGO_SUNAT_PDB_TXT";
        ...
        public DataTable Listar_tipo_de_cambio_txt(string D_AÑO, string D_MES_DESDE, string D_MES_HASTA,
            string V_MONEDA, string UserName)
        {
            try
            {
                StackTrace stack = new StackTrace();
                ...
                InfoMetodoBE oInfoMetodoBE = (InfoMetodoBE)this.MetodoInfo(NombreMetodo);
                string PackageName = sConsulta + ".Pkg_CONTABILIDAD.SP_TIPO_DE_CAMBIO_TXT";
        ...
        public DataTable Listar_centros_de_costo(string V_CENTRO_OPERATIVO, string V_GRUPO_CC_DESDE,
            string V_GRUPO_CC_HASTA, string UserName)
        {
            try
            {
                StackTrace stack = new StackTrace();
                ...
                InfoMetodoBE oInfoMetodoBE = (InfoMetodoBE)this.MetodoInfo(NombreMetodo);
                string PackageName = sConsulta + ".Pkg_CONTABILIDAD.SP_CENTROS_DE_COSTO";
                ...
                Param[1] = new OracleParameter("V_GRUPO_CC_DESDE", OracleDbType.Varchar2);
                Param[1].Direction = ParameterDirection.Input;
                Param[1].Value = V_GRUPO_CC_DESDE;

                Param[2] = new OracleParameter("V_GRUPO_CC_HASTA", OracleDbType.Varchar2);
                Param[2].Direction = ParameterDirection.Input;
                Param[2].Value = V_GRUPO_CC_HASTA;
        ...
        public DataTable Listar_tipo_de_cambio(string V_ANIO, string V_CODMND, string V_MESFIN, string V_MESINI,
            string UserName)
        {
            try
            {
                ...
                InfoMetodoBE oInfoMetodoBE = (InfoMetodoBE)this.MetodoInfo(NombreMetodo);
                string PackageName = sConsulta + ".Pkg_CONTABILIDAD.SP_TIPO_DE_CAMBIO";
                ...
                Param[1] = new OracleParameter("V_CODMND", OracleDbType.Varchar2);
                Param[1].Direction = ParameterDirection.Input;
                Param[1].Value = V_CODMND;
