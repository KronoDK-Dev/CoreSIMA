...
namespace AccesoDatos.NoTransaccional.GestionProyecto
{
    public class OtNTAD : BaseAD
    {
        ...
        public DataTable Listar_detg_pry_ot_sinfact(string CENTRO_OPERATIVO, string DIVISION, string PROYECTO,
            string AÑO, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_PROYECTOS.SP_DetG_PRY_OT_SINFACT";
                ...
                Param[2].Value = PROYECTO.Replace("-", "");
        ...
        public DataTable Listar_detg_pry_ot_sinfact_test(string CENTRO_OPERATIVO, string DIVISION, string PROYECTO,
            string AÑO, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_PROYECTOS.SP_DetG_PRY_OT_SINFACT_TEST";
            ...
            string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_PROYECTOS.SP_OTS_POR_PROYECTO";
