...
namespace WSCore.GestionProduccion
{
    ...
    public class ManodeObra : System.Web.Services.WebService
    {
        ...
        public DataTable BuscarPlanilla_test(String sTipoPL, String cTaller, String cFecha, Int64 n_opcion = 0)
        {
        ...
        public DataTable Conformidad_test(Int64 N_opera, string sFecha, string sUser, string sNivelC = "L", Int64 N_PR = 0, string sTipoPL = null, string sTaller = "X32", string sLinea = "RN",
                                         string sfiltro = "NO", string sTipo_filtro = "", string sdata_filtro = "")
        {
        ...
        [WebMethod(Description = "Listado de Valorizaciones Por: ceo, div, rango fechas y Ots | Arbolito")]
        public DataTable ListarValorizacionPOrOts(int Centro, string CodigoDivision, string FechaIni, string FechaFin, int NOT, string UserName)
        {
            return (new COtsValorizacion()).ListarTodos(Centro, CodigoDivision, FechaIni, FechaFin, NOT, UserName);
        }
        ...
        //[WebMethod(Description = "test Oracle")]
        //public DataTable TestOracle(string IdCentro, string UserName)
        //{
        //    /* if (IntPtr.Size == 4)
        //     {
        ...
        //    return (new CTestOracle()).Prueba2();
        ...
        protected void prCargaCombos(Int64 n_caso = 0, string slinea = "*") // parametro caso: sirve para reutilizar este procedimiento y ejecutar solo una parte de el
        {
            ...
            if (n_caso == 0 || n_caso == 1)
            {
                ...
                try
                {
                    DT = Helper.CallServiceRestOracle(sMetodo_lee_ok, sParametros);
                }
                catch (Exception ex)
                {
        ...
        [WebMethod(Description = "Lista Planilla MOB x TIPO PLANILLA, DIVISION, ÁREA USUARI Y FECHA")]
        public DataTable SP_LISTA_PLANILAxTpxDvxAuxFech(string sTipo, string sDivision, string sAreaU, string sFecha, string UserName)
        {
            return (new COt()).SP_LISTA_PLANILAxTpxDvxAuxFech(sTipo, sDivision, sAreaU, sFecha, sAmbiente, UserName);
        }

        [WebMethod(Description = "Busca los datos de aprobación de una Planilla de conformidad de mano de obra")]
        public DataTable BuscaAprobaciónPLL(string sTipoPL, string cTaller, string sNivel, string sFecha, string UserName)
        {
            return (new COt()).BuscaAprobaciónPLL(sTipoPL, cTaller, sNivel, sFecha, sAmbiente, UserName);
        }
    }
}
