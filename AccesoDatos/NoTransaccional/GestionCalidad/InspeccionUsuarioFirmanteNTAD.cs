...
{
    public class InspeccionUsuarioFirmanteNTAD : BaseAD, IMantenimientoNTAD
    {
        public DataTable Buscar(string TextFind, string UserName)
        {
            try
            {
                ...
                string PackagName = "CALIDAD.CALuspNTADBuscarAPropbadorRI";
        ...
        public DataTable ListarSolicitudAprobacion(int IdUsuario, string UserName)
        {
            try
            {
                ...
                string PackagName = "CALIDAD.CALuspNTADListarSolicutudAprobacionFI";
        ...
        public DataTable ListarTodos(string Id1, string UserName)
        {
            try
            {
                ...
                string PackagName = "CALIDAD.CALuspNTADListarUsuariosFirmantesRefCruz";
        ...
        public DataTable ListarTodos(string Id1, string Id2, string UserName)
        {
            ...
            try
            {
                ...
                string PackagName = "CALIDAD.CALuspNTADListarUsuariosFirmantes";
