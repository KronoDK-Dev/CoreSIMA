    ...
    public class GeneralNTAD : BaseAD
    {
        ...
        public DataTable Listar_TG_EQUIVALENICIASGENERICAS(string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_TG_EQUIVALENICIASGENERICAS";
        ...
        public DataTable Listar_TG_EQUIVALENICIASPORMATERIA(string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_TG_EQUIVALENICIASPORMATERIA";
        ...
        public DataTable Listar_Tg_Unidad_Medida(string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_Tg_Unidad_Medida";
        ...
        public DataTable Listar_Tg_Unidad_Medida2(string unidad, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_Tg_Unidad_Medida2";
                ...
                Param[0] = new OracleParameter("p_unidad", OracleDbType.Varchar2);
                Param[0].Direction = ParameterDirection.Output;
                Param[0].Value = unidad;
