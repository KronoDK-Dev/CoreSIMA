...
namespace AccesoDatos.NoTransaccional.GestionProyecto
{
    public class MaterialesNTAD : BaseAD
    {
        ...
        public DataTable Listar_det_gasto_pry_ot_uti(string V_CENTRO_OPERATIVO, string V_DIVISION, string V_PROYECTO,
            string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_PROYECTOS.SP_DET_GASTO_PRY_OT_UTI";
        ...
        public DataTable Listar_det_gasto_pry_ot_vsm(string V_CENTRO_OPERATIVO, string V_DIVISIÓN, string V_PROYECTO,
            string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_PROYECTOS.SP_DET_GASTO_PRY_OT_VSM";
