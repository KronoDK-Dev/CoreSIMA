...
{
    public class IndicadorConfigCondicionTAD : BaseAD, IMantenimientoTAD
    {
        public int Eliminar()
        {
        ...
        public string ModificaInserta(BaseBE oBaseBE)
        {
            ...
            try
            {
                ...
                string PackagName = "GOBERNANZA.PKG_INDICADOR_TAD.IAreaCondicion";
                ...
                Param[2] = new OracleParameter("CONDICION", OracleDbType.Varchar2);
                Param[2].Direction = ParameterDirection.Input;
                Param[2].Value = oObjAccIndRecBE.Nombre;

                Param[3] = new OracleParameter("IDAREAINFO", OracleDbType.Varchar2);
                Param[3].Direction = ParameterDirection.Input;
                Param[3].Value = oObjAccIndRecBE.IdItemRelacion;


                Param[4] = new OracleParameter("IDCOLOR", OracleDbType.Int64);
