...
{
    public class BienesNTAD : BaseAD
    {
            ...
            string D_FECHA_ALMACENAMIENTO_fina, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_BienesAlmacenados";
                ...
                Param[0] = new OracleParameter("V_CLASE_MATERIAL", OracleDbType.Varchar2);
                Param[0].Direction = ParameterDirection.Input;
                Param[0].Value = V_CLASE_MATERIAL;

                Param[1] = new OracleParameter("D_FECHA_ALMACENAMIENTO_inicial", OracleDbType.Varchar2);
                Param[1].Direction = ParameterDirection.Input;
                Param[1].Value = D_FECHA_ALMACENAMIENTO_inicial;

                Param[2] = new OracleParameter("D_FECHA_ALMACENAMIENTO_fina", OracleDbType.Varchar2);
                Param[2].Direction = ParameterDirection.Input;
                Param[2].Value = D_FECHA_ALMACENAMIENTO_fina;
