...
{
    public class ItemTablaGeneralNTAD : BaseAD, IMantenimientoNTAD
    {
        ...
        public DataTable ListarTodos(string Id1, string UserName)
        {
            try
            {
                ...
                string PackagName = "GENuspNTADItemTablasTablas";
        ...
        public DataTable ListarTablasdeApoyo(string IdtblModulo, string UserName)
        {
            try
            {
                ...
                InfoMetodoBE oInfoMetodoBE = (InfoMetodoBE)this.MetodoInfo(NombreMetodo, IdtblModulo.ToString(), UserName);
                string PackagName = "GEN_uspNTADTablasdeProyo";
                ...
                DataSet ds = Sql(SQLVersion.sqlSIMANET).ExecuteDataSet(PackagName, IdtblModulo);
        ...
        public DataTable ListaConfiguracion(string PageName, string UserName)
        {
            try
            {
                ...
                InfoMetodoBE oInfoMetodoBE = (InfoMetodoBE)this.MetodoInfo(NombreMetodo, PageName, UserName);
                string PackagName = "GENuspNTADConfigOpcionesXWebForms";
                ...
                DataSet ds = Sql(SQLVersion.sqlSIMANET).ExecuteDataSet(PackagName, PageName);
        ...
        {
            return ListarTodosOracle(IdTbl, 0, 0, UserName);
        }
  /*      public DataTable ListarTodosOracle(int IdTbl, string UserName)
        {
            try
            {
                ...
                InfoMetodoBE oInfoMetodoBE = (InfoMetodoBE)this.MetodoInfo(NombreMetodo, IdTbl.ToString(), UserName);

                string PackagName = "SMGENERAL.PKG_GENERAL_NTAD.ITblItemsxTblGen";
...
*/
        ...
        public DataTable ListarTodosOracle(int IdTbl, int IdQuerySelector, int pCOM, string UserName)
        {
            try
            {
                ...
                oParam[1] = new OracleParameter("QuerySelect", OracleDbType.Int64);
                oParam[1].Direction = ParameterDirection.Input;
                oParam[1].Value = IdQuerySelector;

                oParam[2] = new OracleParameter("pCOM", OracleDbType.Int64);
                oParam[2].Direction = ParameterDirection.Input;
                oParam[2].Value = pCOM;// SOLO PARA 
        ...
        public DataTable ListarTodosOracle(int IdTblPadre, int IdItemPadre, string UserName)
        {
            try
            {
                ...
                InfoMetodoBE oInfoMetodoBE = (InfoMetodoBE)this.MetodoInfo(NombreMetodo, IdTblPadre.ToString(), IdItemPadre.ToString(), UserName);
        ...
        public List<Dictionary<string, object>> ListarAreaPorNombre_JSON(int iIdCentroOperativo, string sNombreArea, string UserName)
        {
            try
            {
                ...
                InfoMetodoBE oInfoMetodoBE = (InfoMetodoBE)this.MetodoInfo(NombreMetodo, iIdCentroOperativo.ToString(), sNombreArea.ToString(), UserName);
                string PackagName = "dbo.GENuspNTADConsultarAreaXNombre";
                ...
                DataSet ds = Sql(SQLVersion.sqlSIMANET).ExecuteDataSet(PackagName, iIdCentroOperativo, sNombreArea);
                ...
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    // Debe ejecutarse UNA SOLA VEZ por fila
                    list.Add(dict);
                }
