...
{
    public class AlmacenNTAD : BaseAD
    {
        ...
        public DataTable Listar_OC_Locales_Montos_AlmFac(string V_CEO, string V_OC, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_OC_Locales_Montos_AlmFac";
                ...
                Param[1] = new OracleParameter("V_OC", OracleDbType.Varchar2);
            ...
            string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_SALDO_HIST_ALMACEN_DETALLE";
        ...
        public DataTable Listar_KARDEX_UF_EXONERADO(string V_MES, string V_ANIO, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_KARDEX_UF_EXONERADO";
                ...
                OracleParameter[] Param = new OracleParameter[3];
                Param[0] = new OracleParameter("V_MES", OracleDbType.Varchar2);
                Param[0].Direction = ParameterDirection.Input;
                Param[0].Value = V_MES;
        ...
        public DataTable Listar_KARDEX_UF_GRAVADO(string D_Periodo_Saldo, string D_Mes_Periodo, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_KARDEX_UF_GRAVADO";
                ...
                OracleParameter[] Param = new OracleParameter[3];
                Param[0] = new OracleParameter("D_Periodo_Saldo", OracleDbType.Varchar2);
                Param[0].Direction = ParameterDirection.Input;
                Param[0].Value = D_Periodo_Saldo;

                Param[1] = new OracleParameter("D_Mes_Periodo", OracleDbType.Varchar2);
                Param[1].Direction = ParameterDirection.Input;
                Param[1].Value = D_Mes_Periodo;
        ...
        public DataTable Listar_CTRL_MAT_ALM_OCO(string Fec_inic, string Fec_Final, string Codigo_OT, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_CTRL_MAT_ALM_OCO";
                ...
                Param[0] = new OracleParameter("Fec_inic", OracleDbType.Varchar2);
                Param[0].Direction = ParameterDirection.Input;
                Param[0].Value = Fec_inic;

                Param[1] = new OracleParameter("Fec_Final", OracleDbType.Varchar2);
                Param[1].Direction = ParameterDirection.Input;
                Param[1].Value = Fec_Final;

                Param[2] = new OracleParameter("Codigo_OT", OracleDbType.Varchar2);
                Param[2].Direction = ParameterDirection.Input;
                Param[2].Value = Codigo_OT;
        ...
        public DataTable Listar_SALDO_HIST_ALMACEN_RESUMEN(string Centro_Operativo, string Fecha_de_Proceso,
            string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_SALDO_HIST_ALMACEN_RESUMEN";
        ...
        public DataTable Listar_CTRLMATERIAL_SINFORMAT(string N_CEO, string N_CODMAT, string D_FECHAINI,
            string D_FECHAFIN, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_CTRLMATERIAL_SINFORMAT";
        ...
        public DataTable Listar_SALDO_ALMACEN_DETALLE(string Centro_Operativo, string Codigo_Clase_Material,
            string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_SALDO_ALMACEN_DETALLE";
                ...
                Param[1] = new OracleParameter("Codigo_Clase_Material", OracleDbType.Varchar2);
                Param[1].Direction = ParameterDirection.Input;
                Param[1].Value = Codigo_Clase_Material;
        ...
        public DataTable Listar_SALDO_ALMACEN_RESUMEN(string Centro_Operativo, string Codigo_Clase, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_SALDO_ALMACEN_RESUMEN";
                ...
                Param[1] = new OracleParameter("Codigo_Clase", OracleDbType.Varchar2);
                Param[1].Direction = ParameterDirection.Input;
                Param[1].Value = Codigo_Clase;
        ...
        public DataTable Listar_OcoImpGuias_v1(string ORDEN_COMPRA, string NUMERO_GUIA, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_OcoImpGuias_v1";
                ...
                Param[1] = new OracleParameter("NUMERO_GUIA", OracleDbType.Varchar2);
                Param[1].Direction = ParameterDirection.Input;
                Param[1].Value = NUMERO_GUIA;
        ...
        public DataTable Listar_Vales_Dev_Pqt(string v_CEO, string V_PERIODO, string V_Estado_VDE, string V_Numero_VDE,
            string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_Vales_Dev_Pqt";
                ...
                Param[1] = new OracleParameter("V_PERIODO", OracleDbType.Varchar2);
                Param[1].Direction = ParameterDirection.Input;
                Param[1].Value = V_PERIODO;

                Param[2] = new OracleParameter("V_Estado_VDE", OracleDbType.Varchar2);
                Param[2].Direction = ParameterDirection.Input;
                Param[2].Value = V_Estado_VDE;

                Param[3] = new OracleParameter("V_Numero_VDE", OracleDbType.Varchar2);
                Param[3].Direction = ParameterDirection.Input;
                Param[3].Value = V_Numero_VDE;
        ...
        public DataTable Listar_SaldosAlmacenBalance_Dif(string V_AÑO, string V_MES, string UserName)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".Pkg_LOGISTICA.SP_SaldosAlmacenBalance_Dif";
                ...
                OracleParameter[] Param = new OracleParameter[3];
                Param[0] = new OracleParameter("V_AÑO", OracleDbType.Varchar2);
                Param[0].Direction = ParameterDirection.Input;
                Param[0].Value = V_AÑO;
