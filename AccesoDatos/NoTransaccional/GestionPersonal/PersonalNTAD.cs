...
namespace AccesoDatos.NoTransaccional.GestionPersonal
{
    public class PersonalNTAD : BaseAD, IMantenimientoNTAD
    {
        ...
        public DataTable Buscar(string TextFind, string UserName)
        {
            try
            {
                ...
                string PackagName = "SEGuspNTADBuscarPersonal";
        ...
        public DataTable BuscarTrabajadorContratista(string TextFind, string UserName)
        {
            try
            {
                ...
                InfoMetodoBE oInfoMetodoBE = (InfoMetodoBE)this.MetodoInfo(NombreMetodo, TextFind, UserName);
                string PackagName = "CCTTuspNTADBusquedaPersonalTrabajadorContratista";
        ...
        public DataTable Buscar_Colaborador_xCod(string V_CEO, string V_CODIGO)
        {
            try
            {
                ...
                string PackageName = sConsulta + ".PKG_PROYECTOS.SP_COLABORADOR_O7";
                ...
                Param[1] = new OracleParameter("V_CODIGO", OracleDbType.Varchar2);
                Param[1].Direction = ParameterDirection.Input;
                Param[1].Value = V_CODIGO;
        ...
        public BaseBE Detalle(string Id1, string UserName)
        {
            try
            {
                ...
                InfoMetodoBE oInfoMetodoBE = (InfoMetodoBE)this.MetodoInfo(NombreMetodo, Id1, UserName);
                string PackagName = "SEGuspNTADDetallePersonal";
                ...
                PersonalUbicacionBE oPersonalUbicacionBE = new PersonalUbicacionBE();
                if (ds.Tables[0] != null)
                {
                    DataRow dr = ds.Tables[0].Rows[0];

                    oPersonalUbicacionBE.IdPersonal = Convert.ToInt32(dr["IdPersonal"].ToString());
                    oPersonalUbicacionBE.NroPersonal = dr["NroPersonal"].ToString();
                    oPersonalUbicacionBE.ApellidosyNombres = dr["ApellidosyNombres"].ToString();
                    oPersonalUbicacionBE.EMail = dr["EMail"].ToString();
                    oPersonalUbicacionBE.DocIdentidad = dr["NroDocIdentidad"].ToString();
                    oPersonalUbicacionBE.NombreArea = dr["NombreArea"].ToString();
                }

                return oPersonalUbicacionBE;
            }
        ...
        public BaseBE DetalleO7(string IdPersonal, string UserName)
        {
            try
            {
                StackTrace stack = new StackTrace();
                ...
                InfoMetodoBE oInfoMetodoBE = (InfoMetodoBE)this.MetodoInfo(NombreMetodo, IdPersonal, UserName);
                string PackagName = "SMGENERAL.PKG_GENERAL_NTAD.IDetallePersonal";
                ...
                oParam[0] = new OracleParameter("IdPersonal", OracleDbType.Int64);
                oParam[0].Direction = ParameterDirection.Input;
                oParam[0].Value = IdPersonal;
                ...
                if (ds.Tables[0] != null)
                {
                    ...
                    oPersonalUbicacionBE.IdPersonal = Convert.ToInt32(dr["PTRCODTRA"].ToString());
                    oPersonalUbicacionBE.NroPersonal = dr["PORTARETRATO"].ToString();
                    oPersonalUbicacionBE.ApellidosyNombres = dr["APELLIDOSYNOMBRES"].ToString();
                    oPersonalUbicacionBE.EMail = dr["PTREMAIL"].ToString();
                    oPersonalUbicacionBE.DocIdentidad = dr["NRODOCDNI"].ToString();
                    oPersonalUbicacionBE.NombreArea = dr["NOMBRE_AREA"].ToString();
                    oPersonalUbicacionBE.CodigoArea = dr["COD_AREA"].ToString();
                }
