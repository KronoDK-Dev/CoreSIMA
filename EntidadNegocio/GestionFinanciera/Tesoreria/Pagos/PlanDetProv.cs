...
namespace EntidadNegocio.GestionFinanciera.Tesoreria.Pagos
{
    public  class PlanDetProv
    {
        ...
        public string cAbonarImp { get; set; }
        public string cModuloRaiz { get; set; }
        public string cDigitoControl { get; set; }
        public string cSubTipoPago { get; set; }
        public string cSigno { get; set; }
